...
SOURCES := bluemax.c governor_policy.c gpu_mmio.c gpu_pstate.c runtime.c runtime_config.c thermal.c
HEADERS := governor_policy.h gpu_mmio.h gpu_pstate.h runtime.h runtime_config.h thermal.h
...
RUNTIME_TEST_SOURCES := tests/test_runtime.c tests/test_helpers.c governor_policy.c gpu_mmio.c gpu_pstate.c runtime.c thermal.c
TEST_TARGETS := $(THERMAL_TEST_TARGET) $(GPU_MMIO_TEST_TARGET) $(GPU_PSTATE_TEST_TARGET) $(GOVERNOR_POLICY_TEST_TARGET) $(RUNTIME_CONFIG_TEST_TARGET) $(RUNTIME_TEST_TARGET)
TEST_HEADERS := tests/test_helpers.h governor_policy.h gpu_mmio.h gpu_pstate.h runtime.h runtime_config.h thermal.h
